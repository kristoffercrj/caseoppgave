...
You an also add `--current_weather 1` to print the current weather to your terminal. An example of running `python main.py 25.2 10 temperature_2m --current_weather 1` will show something like this:
